    ...
    (
        fun
            () ->
                ...
                lists:flatten(
                    io_lib:format(
                        "~2..0B.~2..0B.~4..0B ~2..0B:~2..0B:~2..0B.~6..0B",
...
-define(
    L(__Tag, __M, __F, __A),
    io:format(user, ?__T ++ " [" ??__Tag "] {~p,~p} " ++ ?N(__F), [?MODULE, ?LINE | __A])
).
-define(
    L(__Tag, __F, __A),
    io:format(user, ?__T ++ " [" ??__Tag "] {~p,~p} " ++ ?N(__F), [?MODULE, ?LINE | __A])
...
-define(
    L(__Tag, __F),
    io:format(user, ?__T ++ " [" ??__Tag "] {~p,~p} " ++ ?N(__F), [?MODULE, ?LINE])
).
