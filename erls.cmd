set Pa=ebin
set Opts= -pa deps\sqlparse\ebin -setcookie imem -env ERL_MAX_ETS_TABLES 10000 -kernel inet_dist_listen_min 9000 inet_dist_listen_max 9020 -eval "apply(net_adm, ping, ['CM@127.0.0.1'])" -s imem start -imem start_monitor true
