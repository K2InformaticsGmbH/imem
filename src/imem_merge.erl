...
term_diff(LeftType, LeftData, RightType, RightData, Opts, User) when LeftType==integer;LeftType==float;LeftType==decimal ->
    term_diff(number, LeftData, RightType, RightData, Opts, User);
term_diff(LeftType, LeftData, RightType, RightData, Opts, User) when RightType==integer;RightType==float;LeftType==decimal ->
