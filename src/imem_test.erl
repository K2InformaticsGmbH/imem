...
test(_) ->
    try
        ...
        ?Log("success ~p~n", [admin_logged_out]),
        SeCoAdmin1=?imem_test_admin_login(),
        ?Log("success ~p~n", [admin_re_login]),
        ...
        ?Log("success ~p~n", [table_access_rejected_after_logout]),
        ...
        ?Log("success ~p~n", [all_tables_user]), 
        ...
        ?Log("success ~p~n", [have_permission]),
        ?assertEqual(ok, imem_seco:logout(SeCo1)),
        ?Log("success ~p~n", [logout]), 
        ...
        ?Log("----TEST--~p:test_manage_accounts~n", [?MODULE]),
        ...
        ?Log("success ~p~n", [has_permission]),
        ...
        ?Log("success ~p~n", [role_revoke_tc_role]),
        ?assertEqual(true, imem_sec:have_table_permission(SeCo4, user_table_123, select)),
        ?assertEqual(true, imem_sec:have_table_permission(SeCo4, user_table_123, insert)),
        ?assertEqual(true, imem_sec:have_table_permission(SeCo4, user_table_123, delete)),
        ?assertEqual(true, imem_sec:have_table_permission(SeCo4, user_table_123, update)),
        ...
        ?Log("success ~p~n", [role_grant_test_role]), 
        ...
        ?Log("----TEST--~p:test_manage_account_role rejects~n", [?MODULE]),
        ...
        ?Log("success ~p~n", [manage_account_roles_rejects]), 

        ?Log("----TEST--~p:test_manage_account_permissions~n", [?MODULE]),

        ?assertEqual(ok, imem_role:grant_permission(SeCo, test_role, delete_tests)),
        ?Log("success ~p~n", [role_grant_test_role_delete_tests]), 
        ?assertEqual(ok, imem_role:grant_permission(SeCo, test_role, fake_tests)),
        ?Log("success ~p~n", [role_grant_test_role_fake_tests]), 
        ?assertEqual(true, imem_seco:has_permission(SeCo, AccountId, delete_tests)),
        ?Log("success ~p~n", [role_has_delete_tests_permission]), 
        ?assertEqual(true, imem_seco:has_permission(SeCo, AccountId, fake_tests)),
        ?Log("success ~p~n", [role_has_fake_tests_permission]), 
        ...
        ?Log("success ~p~n", [role_revoke_test_role_delete_tests]), 
        ...
        ?Log("success ~p~n", [role_has_delete_tests_permission]), 
        ?assertEqual(ok, imem_role:revoke_permission(SeCo, test_role, delete_tests)),
        ?Log("success ~p~n", [role_revoket_test_role_delete_tests]), 

        ?Log("----TEST--~p:test_manage_account_permission_rejects~n", [?MODULE]),
        ...
        ?Log("success ~p~n", [test_manage_account_permission_rejects]), 
