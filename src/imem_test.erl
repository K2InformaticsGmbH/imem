...
test(_) ->
    try
        ...
        ?Info("success ~p~n", [admin_logged_out]),
        SeCoAdmin1=?imem_test_admin_login(),
        ?Info("success ~p~n", [admin_re_login]),
        ...
        ?Info("success ~p~n", [table_access_rejected_after_logout]),
        ...
        ?Info("success ~p~n", [all_tables_user]), 
        ...
        ?Info("success ~p~n", [test_admin_reauthentication]),
        ...
        ?Info("success ~p~n", [has_permission]),
        ...
        ?Info("success ~p~n", [account_has_has_not_roles]),
        ...
        ?Info("success ~p~n", [create_user_table_unauthorized]),
        ?assertEqual(ok, imem_role:grant_permission(SeCo, table_creator, create_table)),
        ?Info("success ~p~n", [role_re_grant_tc_role]), 
        ?assertEqual(false, imem_seco:has_permission(SeCo, AccountId, manage_user_tables)),
        ...
        ?Info("success ~p~n", [role_revoke_tc_role]),
        ?assertEqual(true, imem_sec:have_table_permission(SeCo4, user_table_123, select)),
        ?assertEqual(true, imem_sec:have_table_permission(SeCo4, user_table_123, insert)),
        ?assertEqual(true, imem_sec:have_table_permission(SeCo4, user_table_123, delete)),
        ?assertEqual(true, imem_sec:have_table_permission(SeCo4, user_table_123, update)),
        ...
        ?Info("success ~p~n", [role_create_test_role]), 
        ...
        ?Info("success ~p~n", [role_has_stupid_permission]), 
        ?assertEqual(false, imem_seco:has_role(SeCo, AccountId, test_role)),
        ?Info("success ~p~n", [role_has_test_role]), 
        ...
        ?Info("success ~p~n", [role_grant_test_role]), 
        ...
        ?Info("success ~p~n", [role_grant_test_role_fake_tests]), 
        ?assertEqual(true, imem_seco:has_permission(SeCo, AccountId, delete_tests)),
        ?Info("success ~p~n", [role_has_delete_tests_permission]), 
        ?assertEqual(true, imem_seco:has_permission(SeCo, AccountId, fake_tests)),
        ?Info("success ~p~n", [role_has_fake_tests_permission]), 
        ...
        ?Info("success ~p~n", [role_revoke_test_role_delete_tests]), 
        ...
        % ?Info("success ~p~n", [grant_manage_system_tables]),
