...
test_with_or_without_sec(IsSec) ->
    try
        ...
        ?assertEqual(ok, imem_sql:exec(SKey, "create table def (col1 varchar2, col2 integer);", 0, 'Imem', IsSec)),
        ...
        ?assertEqual(ok, imem_sql:exec(SKey, "create table not_null (col1 varchar2 not null, col2 integer not null);", 0, 'Imem', IsSec)),
