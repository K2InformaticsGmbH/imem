...
test_with_or_without_sec(IsSec) ->
    try
        ...
        ?assertEqual(ok, imem_sql:exec(SKey, Sql8, 0, [{params,[Pstring8,Patom8]}], IsSec)),
        ...
        ?Info("Sql2: ~p~n", [Sql2]),
        ?assertEqual(ok, imem_sql:exec(SKey, Sql2, 0, [{schema,imem}], IsSec)),
        ...
        ?assertEqual(ok, imem_sql:exec(SKey, Sql2b, 0, [{schema,imem}], IsSec)),
        ...
        ?Info("Sql3: ~p~n", [Sql3]),
        ?assertEqual(ok, imem_sql:exec(SKey, Sql3, 0, [{schema,imem}], IsSec)),
        ...
        ?assertEqual(ok, imem_sql:exec(SKey, Sql3a, 0, [{schema,imem}], IsSec)),
        ...
        ?assertEqual(ok, imem_sql:exec(SKey, Sql3b, 0, [{schema,imem}], IsSec)),
        ...
        ?assertEqual(ok, imem_sql:exec(SKey, Sql4a, 0, [{schema,imem}], IsSec)),
        ...
        ?assertEqual(ok, imem_sql:exec(SKey, Sql4c, 0, [{schema,imem}], IsSec)),
        ...
        ?assertEqual(ok, imem_sql:exec(SKey, Sql4d, 0, [{schema,imem}], IsSec)),
        ...
        ?assertEqual(ok, imem_sql:exec(SKey, Sql4e, 0, [{schema,imem}], IsSec)),
        ...
        ?assertEqual(ok, imem_sql:exec(SKey, Sql4f, 0, [{schema,imem}], IsSec)),
        ...
        ?assertEqual(ok, imem_sql:exec(SKey, Sql4g, 0, [{schema,imem}], IsSec)),
        ...
        ?assertEqual(ok, imem_sql:exec(SKey, Sql4h, 0, [{schema,imem}], IsSec)),
        ...
        ?Info("Sql6: ~p~n", [Sql6]),
        ?assertException(throw,{CoEx,{"Insert failed, row already exists",_}}, imem_sql:exec(SKey, Sql6, 0, [{schema,imem}], IsSec)),
        ...
        ?Info("Sql7: ~p~n", [Sql7]),
        ?assertException(throw,{ClEr,{"Missing key column for insert into table",_}}, imem_sql:exec(SKey, Sql7, 0, [{schema,imem}], IsSec)),
        ...
        ?assertEqual(ok, imem_sql:exec(SKey, Sql21, 0, [{schema,imem}], IsSec)),
        ?assertEqual(1,  if_call_mfa(IsSec, table_size, [SKey, not_null])),

        Sql22 = "insert into not_null (col2) values (5);",
        ?Info("Sql22: ~p~n", [Sql22]),
        ?assertException(throw, {ClEr,{"Missing key column for insert into table",_}}, imem_sql:exec(SKey, Sql22, 0, [{schema,imem}], IsSec)),
